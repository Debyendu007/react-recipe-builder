...
garudapro.webapi.common=garudapro.webapi.common||{};garudapro.webapi.version="1.0.0";garudapro.webapi.debug=true;garudapro.webapi.common.printLog=function(message){if(typeof garudapro.webapi.debug!==typeof undefined&&garudapro.webapi.debug==true)console.log("[Garuda-WEB-SDK]: "+message)};garudapro.webapi.protocol.header=function(header){this.id=header;this.version="2.0"};
...
garudapro.webapi.extended.sendSelectedDevice=function(sourceGadgetName,sourceGadgetID,user_id,device_id){garudapro.webapi.common.printLog("Trying to call sendSelectedDevice");var request=new garudapro.webapi.scylla.ScyllRequest("DeviceSelectRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("device_id",device_id);request.sendRequestToGateway()};
...
garudapro.webapi.extended.SendCancelRecipeToGadgetRequest=function(sourceGadgetName,sourceGadgetID,targetGadgetID,targetGadgetName,targetGadgetType,user_id,device_id,notification_type,message){garudapro.webapi.common.printLog("Trying to call SendCancelRecipeToGadgetRequest");var request=new garudapro.webapi.scylla.ScyllRequest("SendNotificationToGadgetRequest",sourceGadgetName,sourceGadgetID);request.add("targetGadgetID",targetGadgetID);request.add("targetGadgetName",targetGadgetName);request.add("uid",
user_id);request.add("device_id",device_id);request.add("type",notification_type);request.add("message",message);request.sendRequestToGateway()};
...
garudapro.webapi.extended.SendRecipeOutputToRecipePlayer=function(sourceGadgetID,sourceGadgetName,targetGadgetName,targetGadgetID,targetGadgetType,recipeID,data,isStream,filename,inputfileextension,inputfileformat,fileSequenceNo,parameters,user_id){garudapro.webapi.common.printLog("Trying to call SendRecipeDataToGadgetRequest");var request=new garudapro.webapi.scylla.ScyllRequest("SendRecipeDataToGadgetRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("targetGadgetName",
targetGadgetName);request.add("targetGadgetID",targetGadgetID);request.add("targetGadgetType",targetGadgetType);request.add("recipeID",recipeID);request.add("data",data);request.add("isStream",isStream);request.add("filename",filename);request.add("inputfileextension",inputfileextension);request.add("inputfileformat",inputfileformat);request.add("fileSequenceNo",fileSequenceNo);request.add("parameters",parameters);request.sendRequestToGateway()};
...
garudapro.webapi.extended.SendRecipeInputACKToRecipePlayer=function(sourceGadgetID,sourceGadgetName,targetGadgetID,targetGadgetName,targetGadgetType,recipeID,user_id,fileSequenceNo,result){garudapro.webapi.common.printLog("Trying to call SendRecipeDataToGadgetResponse");var request=new garudapro.webapi.scylla.ScyllRequest("SendRecipeDataToGadgetResponse",sourceGadgetName,sourceGadgetID);request.add("recipeID",recipeID);request.add("uid",user_id);request.add("sourceGadgetID",sourceGadgetID);request.add("sourceGadgetName",
sourceGadgetName);request.add("targetGadgetID",targetGadgetID);request.add("targetGadgetName",targetGadgetName);request.add("targetGadgetType",targetGadgetType);request.add("fileSequenceNo",fileSequenceNo);request.add("result",result);request.sendRequestToGateway()};
...
garudapro.webapi.extended.getLogDataRequest=function(sourceGadgetId,sourceGadgetName,log_type,line_start,line_limit,start_date,end_date,protocol_header,filter_txt){garudapro.webapi.common.printLog("Trying to fetch log data");var request=new garudapro.webapi.scylla.ScyllRequest("GetLogDataRequest",sourceGadgetName,sourceGadgetId);request.add("logType",log_type);request.add("lineStart",line_start);request.add("lineLimit",line_limit);request.add("startDate",start_date);request.add("endDate",end_date);
request.add("protocol",protocol_header);request.add("filterText",filter_txt);request.sendRequestToGateway()};garudapro.webapi.extended.getAllLogFilesRequest=function(sourceGadgetId,sourceGadgetName){garudapro.webapi.common.printLog("Trying to fetch all log files");var request=new garudapro.webapi.scylla.ScyllRequest("GetAllLogFilesRequest",sourceGadgetName,sourceGadgetId);request.sendRequestToGateway()};
garudapro.webapi.extended.deleteLogFileRequest=function(sourceGadgetId,sourceGadgetName,filename){garudapro.webapi.common.printLog("Trying to fetch all log files");var request=new garudapro.webapi.scylla.ScyllRequest("DeleteLogFileRequest",sourceGadgetName,sourceGadgetId);request.add("filename",filename);request.sendRequestToGateway()};
garudapro.webapi.extended.deleteLogDataRequest=function(sourceGadgetId,sourceGadgetName,log_type,date){garudapro.webapi.common.printLog("Trying delete a log file");var request=new garudapro.webapi.scylla.ScyllRequest("DeleteLogDataRequest",sourceGadgetName,sourceGadgetId);request.add("logType",log_type);request.add("date",date);request.sendRequestToGateway()};
garudapro.webapi.extended.deleteLogDocumentRequest=function(sourceGadgetId,sourceGadgetName,log_type,logIds){garudapro.webapi.common.printLog("Trying delete a log file");var request=new garudapro.webapi.scylla.ScyllRequest("DeleteLogDocumentsRequest",sourceGadgetName,sourceGadgetId);request.add("logType",log_type);request.add("logIds",logIds);request.sendRequestToGateway()};
garudapro.webapi.extended.getOutstreamGadgetListRequest=function(sourceGadgetName,sourceGadgetID,user_id,fileExtension,fileFormat,targetGadgetKey){garudapro.webapi.common.printLog("Trying to fetch compatible outstream gadgets");var request=new garudapro.webapi.scylla.ScyllRequest("getOutstreamGadgetListRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("fileExtension",fileExtension);request.add("fileFormat",fileFormat);request.add("targetGadgetKey",targetGadgetKey);request.sendRequestToGateway()};
garudapro.webapi.extended.getRecipeInputCountListRequest=function(sourceGadgetName,sourceGadgetID,user_id,type_array){garudapro.webapi.common.printLog("Trying to fetch recipe input count list");var request=new garudapro.webapi.scylla.ScyllRequest("getRecipeInputCountListRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("type_array",type_array);request.sendRequestToGateway()};
garudapro.webapi.extended.getRecipeInputFormatListByGadgetType=function(sourceGadgetName,sourceGadgetID,user_id,type_array,count){garudapro.webapi.common.printLog("Trying to fetch recipe input list by gadget type");var request=new garudapro.webapi.scylla.ScyllRequest("getRecipeInputFormatListByGadgetTypeRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("type_array",type_array);request.add("count",count);request.sendRequestToGateway()};
garudapro.webapi.extended.getcompatibleRecipeGadagetListRequest=function(sourceGadgetName,sourceGadgetID,user_id,input_list,recipe_type){garudapro.webapi.common.printLog("Trying to fetch recipe enabled compatible gadgets");var request=new garudapro.webapi.scylla.ScyllRequest("GetcompatibleRecipeGadagetListRequest",sourceGadgetName,sourceGadgetID);request.add("uid",user_id);request.add("input_list",input_list);request.add("recipeType",recipe_type);request.sendRequestToGateway()};garudapro.webapi.base.Activate=function(sourceGadgetName,sourceGadgetID,debug){garudapro.webapi.base.request.activate=new garudapro.webapi.scylla.ScyllRequest("ActivateGadgetRequest",sourceGadgetName,sourceGadgetID);if(typeof debug!==typeof undefined&&debug==true){garudapro.webapi.debug=true;garudapro.webapi.common.printLog("ENABLE WEB-SDK IN DEBUG mode");garudapro.webapi.base.request.activate.add("debug",true)}garudapro.webapi.common.printLog("Trying to call Activate");garudapro.webapi.base.request.activate.sendRequestToGateway()};
...
handleGetAllAddedReceivedFilesResponse(message)}else if(header=="DeleteAddedReceivedFileResponse"){var message=jsonResponseObject.body;handleDeleteAddedReceivedFileResponse(message)}else if(header=="GetWebGadgetsResponse"){var message=jsonResponseObject.body;handlegetWebGadgetsResponse(message)}else if(header=="DeleteWebGadgetsResponse"){var message=jsonResponseObject.body;handleDeleteWebGadgetsResponse(message)}else if(header=="GetLogDataResponse"){var message=jsonResponseObject.body;handleReceivedLogData(message)}else if(header==
"GetAllLogFilesResponse"){var message=jsonResponseObject.body;handleReceivedAllLogFiles(message)}else if(header=="DeleteLogFileResponse"){var message=jsonResponseObject.body;handleDeleteLogFileResponse(message)}else if(header=="DeleteLogDataResponse"){var message=jsonResponseObject.body;handleDeleteLogDataResponse(message)}else if(header=="DeleteLogDocumentsResponse"){var message=jsonResponseObject.body;handleDeleteLogDocumentsResponse(message)}else if(header=="getOutstreamGadgetListResponse"){var message=
jsonResponseObject.body;handleOutstreamGadgetListResponse(message)}else if(header=="getRecipeInputCountListResponse"){var message=jsonResponseObject.body;handleRecipeInputCountListResponse(message)}else if(header=="getRecipeInputFormatListByGadgetTypeResponse"){var message=jsonResponseObject.body;handleRecipeInputFormatListResponse(message)}else if(header=="GetcompatibleRecipeGadagetListResponse"){var message=jsonResponseObject.body;handlegetcompatibleRecipeGadagetListResponse(message)}};
function handleDeviceSelectResponse(jsonResponseObject){}function handleLoadDataRequestResponse(jsonResponseObject){}function handleSendRecipeDataToGadgetResponse(jsonResponseObject){}function handleLoadGadgetThroughCoreResponse(jsonResponseObject){}function handleSendNotificationToGadget(jsonResponseObject){}function handleDeleteGadgetFromCoreResponse(jsonResponseObject){}function handleGetGadgetDetailsResponse(jsonResponseObject){}function handleClientConnection(jsonResponseObject){}
function handleDeviceListResponse(jsonResponseObject){}function handleActivateGadgetResponse(jsonResponseObject){}function handleLoginSuccessResponse(jsonResponseObject){}function handleLoginFailResponse(jsonResponseObject){}function handleSentDataToGadgetRequest(jsonResponseObject){}function handleSentDataToGadgetResponse(jsonResponseObject){}function handleGetCompatibleGadgetListResponse(jsonResponseObject){}function handleLogoutResponse(jsonResponseObject){}
function handleAddCategoriesResponse(jsonResponseObject){}function handleDeleteCategoriesResponse(jsonResponseObject){}function handleGetPipelineDetailsResponse(jsonResponseObject){}function handleDeletePipelineResponse(jsonResponseObject){}function handleGetDeviceStatusResponse(jsonResponseObject){}function handleGetExtensionFormatMapResponse(jsonResponseObject){}function handleNetworkConnectFailure(jsonResponseObject){}function handleResponseCode(responseCode,responseHeader){}
function handleSendRecipeDataToGadgetRequest(jsonResponseObject){}function handleGetActionTagsResponse(jsonResponseObject){}function handleGetDataTagsResponse(jsonResponseObject){}function handleSaveAddedReceivedFileResponse(jsonResponseObject){}function handleGetAllAddedReceivedFilesResponse(jsonResponseObject){}function handleDeleteAddedReceivedFileResponse(jsonResponseObject){}function handlegetWebGadgetsResponse(message){}function handleDeleteWebGadgetsResponse(message){}
function handleReceivedLogData(message){}function handleReceivedAllLogFiles(message){}function handleDeleteLogFileResponse(message){}function handleDeleteLogDataResponse(message){}function handleOutstreamGadgetListResponse(message){}function handleRecipeInputCountListResponse(message){}function handleRecipeInputFormatListResponse(message){}function handlegetRecipeOutputByGadgetIDResponse(message){}function handlegetcompatibleRecipeGadagetListResponse(message){};var NOTIFICATION_REFRESH_DASHBOARD=600;var NOTIFICATION_UPDATE_GADGET=601;var NOTIFICATION_CLOSE_GADGET=604;var NOTIFICATION_DOWNLOAD_START=607;var NOTIFICATION_DOWNLOAD_END=608;var NOTIFICATION_DOWNLOAD_FAIL=609;var NOTIFICATION_GADGET_STATUS=610;var NOTIFICATION_CORE_UPDATING=612;var NOTIFICATION_NEW_PIPELINE=614;var NOTIFICATION_GADGET_DETAILS_UPDATE=616;var NOTIFICATION_MULTIPLE_INSTANCE=699;var NOTIFICATION_REFRESH_GADGET_LIST=703;var NOTIFICATION_GADGET_UPDATE_CONFIRM=705;
